...
<body>
    <form action="../actions/login_parceiro.php" method="POST">
    <div class="main-login">
        <div class="left-login">
            <h1>Faça login <br> e distribua seus cupons!!</h1>
        ...
        <div class="right-login">
            <div class="card-login">
                ...
                <p>Não tem conta? Clique <a href="cad_form_parceiro.php">aqui!</a></p>
            </div>
